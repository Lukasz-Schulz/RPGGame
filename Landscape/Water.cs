...
namespace Gra
{
    public class Water : ILandscapeObject //concrete landscape object adding itself to a list in constructor
    {
        public Avatar Element { get; protected set; }
        public string ImagePath { get; } = @"C:\Users\LEN\source\repos\Gra\Gra\Graphics\Water.jpg";
